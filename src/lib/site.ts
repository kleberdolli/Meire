...
export const attendanceSteps = [
  ...
  },
  {
    ...
    description:
      "Conversamos sobre sua história, objetivos e expectativas para compreender o melhor caminho terapêutico.",
  },
  {
    step: "03",
  ...
  },
  {
    ...
    description:
      "As sessões seguem com escuta, acolhimento e intervenções consistentes com ética e responsabilidade.",
  },
] as const;
...
export const processExpectations = [
  ...
  },
  {
    ...
    description:
      "Construção conjunta de estratégias práticas para aplicar no cotidiano, respeitando seu tempo e limites.",
  },
] as const;

export const strategicPhotos = [
  {
    id: "consultorio",
    label: "Consultório",
  ...
  {
    id: "detalhe",
    label: "Detalhe do espaço",
    description: "Elementos que reforçam acolhimento e profissionalismo.",
  },
  {
    id: "atendimento",
    label: "Atendimento",
...
export const faqItems = [
  {
    ...
    answer:
      "A sessão inicial é um momento de acolhimento para compreender sua demanda, histórico relevante e expectativas em relação ao processo terapêutico.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Não. As informações aqui apresentadas têm caráter institucional e não substituem avaliação, diagnóstico ou acompanhamento psicológico.",
  },
] as const;
