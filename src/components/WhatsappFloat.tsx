...
export function WhatsappFloat() {
  ...
  return (
    <a
      ...
      aria-label="Falar com a psicóloga no WhatsApp"
      className="fixed bottom-5 right-5 z-50 inline-flex h-[2.8rem] w-[2.8rem] items-center justify-center rounded-full border border-[#2d9e65]/40 bg-[#1f7a4d]/60 text-white shadow-soft backdrop-blur-sm transition hover:scale-105 hover:bg-[#1f7a4d]/80"
    >
