...
const floatingButtonSize =
  "inline-flex h-11 w-11 items-center justify-center rounded-full shadow-soft transition hover:scale-105 sm:h-12 sm:w-12";
  ...
  return (
    ...
    >
      <a
        ...
        className={`${floatingButtonSize} border border-[#2d9e65]/40 bg-[#1f7a4d]/60 text-white backdrop-blur-sm hover:bg-[#1f7a4d]/80`}
      >
