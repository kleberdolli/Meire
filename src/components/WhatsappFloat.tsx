...
export function WhatsappFloat() {
  ...
  return (
    <a
      ...
      className="fixed bottom-5 right-5 z-50 inline-flex h-14 w-14 items-center justify-center rounded-full bg-[#1f7a4d] text-white shadow-soft transition hover:scale-105 hover:bg-[#17633d]"
    >
